...
namespace Falson.SquadRoleRandomizer
{
    ...
    public class RoleRandomizerMain : Blish_HUD.Modules.Module
    {
        ...
        private void BuildTabs() //add 3 tabs to the window, getting a settings object based on the base64string for each and passing that to the new view for the tab
        {
            ...
            _randomizerSettingsTabbedWindow.Tabs.Add(new Tab(ContentsManager.GetTexture("SettingsIcon.png"), () => new StaticViewMain(),"Static Settings"));
            _randomizerSettingsTabbedWindow.Tabs.Add(new Tab(ContentsManager.GetTexture("Emblem.png"), () => new GeneratorView(_base64strings),"Randomizer Settings"));
        }
