...
namespace Falson.SquadRoleRandomizer
{
    public class StaticView : View
    {
        ...
        protected override void Build(Container buildPanel)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                _tankBoxArray[i] = new CustomCheckbox(_deserializedSettings._tankRoles[i], isChecked =>{_deserializedSettings._tankRoles[i] = isChecked;}){ Text = "Tank", Location = new Point(0, 0), BasicTooltipText = "Tank", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._tankRoles[i] };
                _healAlacBoxArray[i] = new CustomCheckbox(_deserializedSettings._healAlacRoles[i], isChecked => { _deserializedSettings._healAlacRoles[i] = isChecked; }) { Text = "Heal + Alac", Location = new Point(0, 25), BasicTooltipText = "Heal + Alac", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._healAlacRoles[i] };
                _healQuickBoxArray[i] = new CustomCheckbox(_deserializedSettings._healQuickRoles[i], isChecked => { _deserializedSettings._healQuickRoles[i] = isChecked; }) { Text = "Heal + Quick", Location = new Point(0, 50), BasicTooltipText = "Heal + Quick", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._healQuickRoles[i] };
                _dpsAlacBoxArray[i] = new CustomCheckbox(_deserializedSettings._dpsAlacRoles[i], isChecked => { _deserializedSettings._dpsAlacRoles[i] = isChecked; }) { Text = "DPS + Alac", Location = new Point(100, 0), BasicTooltipText = "DPS + Alac", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._dpsAlacRoles[i] };
                _dpsQuickBoxArray[i] = new CustomCheckbox(_deserializedSettings._dpsQuickRoles[i], isChecked => { _deserializedSettings._dpsQuickRoles[i] = isChecked; }) { Text = "DPS + Quick", Location = new Point(100, 25), BasicTooltipText = "DPS + Quick", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._dpsQuickRoles[i] };
