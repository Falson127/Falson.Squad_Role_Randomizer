...
namespace Falson.SquadRoleRandomizer
{
    public class StaticView : View
    {
        ...
        public StaticView(FalsonSettings deserializedSettings, SettingEntry<string> base64SettingsString, int activeSettingIndex)//, Tab viewWindowTab)
        {
            _deserializedSettings = deserializedSettings;
            _activeSettingIndex = activeSettingIndex;
        }
        protected override void Build(Container buildPanel)
        {
            ...
            {
                int i = j;
                _tankAlacBoxArray[i] = new CustomCheckbox(_deserializedSettings._tankAlacRoles[i], isChecked =>{_deserializedSettings._tankAlacRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings);}){ Text = "Heal + Alac Tank", Location = new Point(0, 0), BasicTooltipText = "Heal + Alac Tank", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._tankAlacRoles[i] };
                _tankQuickBoxArray[i] = new CustomCheckbox(_deserializedSettings._tankQuickRoles[i], isChecked => { _deserializedSettings._tankQuickRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings);}) { Text = "Heal + Quick Tank", Location = new Point(0,25), BasicTooltipText = "Heal + Quickness Tank", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._tankQuickRoles[i] };
                _healAlacBoxArray[i] = new CustomCheckbox(_deserializedSettings._healAlacRoles[i], isChecked => { _deserializedSettings._healAlacRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Heal + Alac", Location = new Point(0, 50), BasicTooltipText = "Heal + Alac", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._healAlacRoles[i] };
                _healQuickBoxArray[i] = new CustomCheckbox(_deserializedSettings._healQuickRoles[i], isChecked => { _deserializedSettings._healQuickRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Heal + Quick", Location = new Point(150, 0), BasicTooltipText = "Heal + Quick", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._healQuickRoles[i] };
                _dpsAlacBoxArray[i] = new CustomCheckbox(_deserializedSettings._dpsAlacRoles[i], isChecked => { _deserializedSettings._dpsAlacRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "DPS + Alac", Location = new Point(150, 25), BasicTooltipText = "DPS + Alac", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._dpsAlacRoles[i] };
                _dpsQuickBoxArray[i] = new CustomCheckbox(_deserializedSettings._dpsQuickRoles[i], isChecked => { _deserializedSettings._dpsQuickRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "DPS + Quick", Location = new Point(150, 50), BasicTooltipText = "DPS + Quick", Parent = _standardRolesPanel[i], Checked = _deserializedSettings._dpsQuickRoles[i] };

                _handKiteBoxArray[i] = new CustomCheckbox(_deserializedSettings._handKiteRoles[i], isChecked => { _deserializedSettings._handKiteRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Hand Kite", Location = new Point(0, 0), BasicTooltipText = "Hand Kite", Parent = _hoTMechanicsPanel[i], Checked = _deserializedSettings._handKiteRoles[i] };
                _oilKiteBoxArray[i] = new CustomCheckbox(_deserializedSettings._oilKiteRoles[i], isChecked => { _deserializedSettings._oilKiteRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Oil Kite", Location = new Point(0, 25), BasicTooltipText = "Oil Kite", Parent = _hoTMechanicsPanel[i], Checked = _deserializedSettings._oilKiteRoles[i] };
                _flakKiteBoxArray[i] = new CustomCheckbox(_deserializedSettings._flakKiteRoles[i], isChecked => { _deserializedSettings._flakKiteRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Flak Kite", Location = new Point(0, 50), BasicTooltipText = "Flak Kite", Parent = _hoTMechanicsPanel[i], Checked = _deserializedSettings._flakKiteRoles[i] };
                _mushroomBoxArray[i] = new CustomCheckbox(_deserializedSettings._mushroomRoles[i], isChecked => { _deserializedSettings._mushroomRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Mushroom", Location = new Point(100, 0), BasicTooltipText = "Slothosaur Mushroom", Parent = _hoTMechanicsPanel[i], Checked = _deserializedSettings._mushroomRoles[i] };
                _towerBoxArray[i] = new CustomCheckbox(_deserializedSettings._towerRoles[i], isChecked => { _deserializedSettings._towerRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Tower", Location = new Point(100, 25), BasicTooltipText = "Tower Mesmer", Parent = _hoTMechanicsPanel[i], Checked = _deserializedSettings._towerRoles[i] };
                _reflectBoxArray[i] = new CustomCheckbox(_deserializedSettings._reflectRoles[i], isChecked => { _deserializedSettings._reflectRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Reflect", Location = new Point(100, 50), BasicTooltipText = "Matthias Reflect", Parent = _hoTMechanicsPanel[i], Checked = _deserializedSettings._reflectRoles[i] };
                _cannonBoxArray[i] = new CustomCheckbox(_deserializedSettings._cannonRoles[i], isChecked => { _deserializedSettings._cannonRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Cannons", Location = new Point(200, 0), BasicTooltipText = "Sabetha Cannons", Parent = _hoTMechanicsPanel[i], Checked = _deserializedSettings._cannonRoles[i] };
                _construcPusherBoxArray[i] = new CustomCheckbox(_deserializedSettings._construcPusherRoles[i], isChecked => { _deserializedSettings._construcPusherRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "KC Pusher", Location = new Point(200, 25), BasicTooltipText = "Keep Construct Pusher", Parent = _hoTMechanicsPanel[i], Checked = _deserializedSettings._construcPusherRoles[i] };

                _lampBoxArray[i] = new CustomCheckbox(_deserializedSettings._lampRoles[i], isChecked => { _deserializedSettings._lampRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Lamp", Location = new Point(0, 0), BasicTooltipText = "Qadim Lamp", Parent = _poFMechanicsPanel[i], Checked = _deserializedSettings._lampRoles[i] };
                _pylonBoxArray[i] = new CustomCheckbox(_deserializedSettings._pylonRoles[i], isChecked => { _deserializedSettings._pylonRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Pylon", Location = new Point(0, 25), BasicTooltipText = "Qadim Pylon", Parent = _poFMechanicsPanel[i], Checked = _deserializedSettings._pylonRoles[i] };
                _pillarBoxArray[i] = new CustomCheckbox(_deserializedSettings._pillarRoles[i], isChecked => { _deserializedSettings._pillarRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Pillar", Location = new Point(0, 50), BasicTooltipText = "Adina Pillar", Parent = _poFMechanicsPanel[i], Checked = _deserializedSettings._pillarRoles[i] };
                _greenBoxArray[i] = new CustomCheckbox(_deserializedSettings._greenRoles[i], isChecked => { _deserializedSettings._greenRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Green", Location = new Point(100, 0), BasicTooltipText = "Dhuum Green", Parent = _poFMechanicsPanel[i], Checked = _deserializedSettings._greenRoles[i] };
                _soullessPusherBoxArray[i] = new CustomCheckbox(_deserializedSettings._soullessPusherRoles[i], isChecked => { _deserializedSettings._soullessPusherRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "SH Pusher", Location = new Point(100, 25), BasicTooltipText = "Soulless Horror Pusher", Parent = _poFMechanicsPanel[i], Checked = _deserializedSettings._soullessPusherRoles[i] };
                _dhuumKiteBoxArray[i] = new CustomCheckbox(_deserializedSettings._dhuumKiteRoles[i], isChecked => { _deserializedSettings._dhuumKiteRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Dhuum Kiter", Location = new Point(100, 50), BasicTooltipText = "Dhuum Messenger Kiter", Parent = _poFMechanicsPanel[i], Checked = _deserializedSettings._dhuumKiteRoles[i] };
                _qadimKiteBoxArray[i] = new CustomCheckbox(_deserializedSettings._qadimKiteRoles[i], isChecked => { _deserializedSettings._qadimKiteRoles[i] = isChecked; RoleRandomizerMain._base64strings[_activeSettingIndex].Value = SettingsEncoder.UpdateBase64(_deserializedSettings); }) { Text = "Qadim Kiter", Location = new Point(200, 0), BasicTooltipText = "Qadim Kiter", Parent = _poFMechanicsPanel[i], Checked = _deserializedSettings._qadimKiteRoles[i] };
